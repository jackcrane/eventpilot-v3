...
export const Event = () => {
  ...
  return (
    <EventPage title="Event">
      <Card title="Progress" className={"mb-3"}>
        <Row gap={2} align="flex-start">
          ...
          <div>
            ...
            <Typography.Text style={{ fontSize: "2rem" }} className="mb-0">
              ...
              {days > 1 ? `${days} days` : days === 1 ? "1 day" : "Today!"}
            </Typography.Text>
          </div>
          <Divider />
          <div>
            ...
            <Typography.Text>
              Every good event needs good volunteers. We are tracking the number
              of volunteers who have registered for your event for you.
            </Typography.Text>
