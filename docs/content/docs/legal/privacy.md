...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EventPilot.
...
- __Website__ refers to EventPilot, accessible from [https://geteventpilot.com](https://geteventpilot.com)
...
- By email: support@geteventpilot.com